...
{		TIM1_Delay_1=100;
		...
		if (Line_Y1<47 && (Line_delay>0) ) Line_Y1++; else {Line_Y1=0; Line_X1=(uint8_t)TIM2_Delay_1;}
		if (Line_Y2<47 && (Line_delay>12)) Line_Y2++; else {Line_Y2=0; Line_X2=(uint8_t)TIM2_Delay_1;}
		if (Line_Y3<47 && (Line_delay>24)) Line_Y3++; else {Line_Y3=0; Line_X3=(uint8_t)TIM2_Delay_1;}
		if (Line_Y4<47 && (Line_delay>36)) Line_Y4++; else {Line_Y4=0; Line_X4=(uint8_t)TIM2_Delay_1;}
		if (Line_Y5<47 && (Line_delay>48)) Line_Y5++; else {Line_Y5=0; Line_X5=(uint8_t)TIM2_Delay_1;}
		if (Line_Y6<47 && (Line_delay>60)) Line_Y6++; else {Line_Y6=0; Line_X6=(uint8_t)TIM2_Delay_1;}

	}
/*
	sprintf (String,"%d",Line_X1);
Nokia_5110_String(0,0,(uint8_t*)String);
sprintf (String,"%d",Line_X2);
Nokia_5110_String(0,8,(uint8_t*)String);
sprintf (String,"%d",Line_X3);
