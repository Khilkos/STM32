...
FSMC_Bank1->BTCR[1] =		0 << FSMC_BTR1_ACCMOD_Pos			| // Access mode 0 = A, 1 = B, 2 = C, 3 = D Use w/EXTMOD bit
												...
												0 << FSMC_BTR1_BUSTURN_Pos 		| // Bus turnaround phase duration 0...F, расстояние между посылками
												1 << FSMC_BTR1_DATAST_Pos 		| // Data-phase duration 1..FF * 2 * HCLK, длительность фазы данных
