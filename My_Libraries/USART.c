...
USARTx->BRR = 0;
USARTx->BRR |= 1093UL<<USART_BRR_DIV_Mantissa_Pos; //set usart baud 9600 //312 для 48МГц //1093 для 168 МГц (частота процессора)
USARTx->BRR |= 12UL<<USART_BRR_DIV_Fraction_Pos;	//8 для 48МГц // 12 для 168 МГц
USART2->CR1 |= USART_CR1_UE;	
}
//=======================================
...
//USART2->CR1 &= ~USART_CR1_UE;
USARTx->BRR = 0;
USARTx->BRR |= 91UL<<USART_BRR_DIV_Mantissa_Pos; //26 для 48МГц
USARTx->BRR |= 2UL<<USART_BRR_DIV_Fraction_Pos;	//1 для 48Мгц
//USART2->CR1 |= USART_CR1_UE;	
}
