...
USARTx->BRR = 0;
USARTx->BRR |= 273UL<<USART_BRR_DIV_Mantissa_Pos; //set usart baud 9600 //312 для 48МГц //273 для 42 МГц
USARTx->BRR |= 7UL<<USART_BRR_DIV_Fraction_Pos;	//8 для 48МГц // 7 для 42 МГц
USART2->CR1 |= USART_CR1_UE;	
}
//=======================================
