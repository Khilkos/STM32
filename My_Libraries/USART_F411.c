...
//=======================================
void USART_F411_set_9600_baud (void)
{
...
//=======================================
void USART_F411_set_115200_baud (void)
{
//USART2->CR1 &= ~USART_CR1_UE;
USART2->BRR = 0;
...
//=======================================
void USART_F411_DMAT_ON (void)
{
USART2->CR3 |= USART_CR3_DMAT ;
}

//=======================================
void USART_F411_DMAR_ON (void)
{
USART2->CR3 |= USART_CR3_DMAR;
}
...
//======================================
void USART_F411_DMAR_OFF (void)
{
USART2->CR3 &= ~USART_CR3_DMAR;
}

//=================================
void USART_F411_DMAT_OFF (void)
{
USART2->CR3 &= ~USART_CR3_DMAT;
}
